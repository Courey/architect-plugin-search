...
export const manifest = [
  {
    ...
    type: 'Linux',
    arch: 'x64',
    url: 'https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.13.3-linux-x86_64.tar.gz',
  },
  {
    engine: 'elasticsearch',
    type: 'Linux',
    arch: 'arm64',
    url: 'https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.13.3-linux-aarch64.tar.gz',
  },
  {
    engine: 'elasticsearch',
    type: 'Darwin',
    arch: 'x64',
    url: 'https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.13.3-darwin-x86_64.tar.gz',
  },
  {
    engine: 'elasticsearch',
    type: 'Darwin',
    arch: 'arm64',
    url: 'https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.13.3-darwin-aarch64.tar.gz',
  },
  {
    engine: 'elasticsearch',
    type: 'Windows_NT',
